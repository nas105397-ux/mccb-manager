...
export default function AdminPanel({
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-red-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 space-y-3">
                ...
                <div key={r} className="flex items-center justify-between text-xs p-1.5 bg-gray-50 rounded border border-gray-100">
                  ...
                  <div className="flex gap-1">
                    <button 
                      ...
                      className="text-blue-600 hover:bg-blue-50 px-1.5 py-0.5 rounded font-bold cursor-pointer"
                    >
                      編集
                    </button>
                    <button 
                      onClick={() => deleteRoom(r)} 
                      className="text-red-600 hover:bg-red-50 px-1.5 py-0.5 rounded font-bold cursor-pointer"
                    >
                      削除
                    </button>
                  </div>
            ...
            <div className="flex gap-1.5">
              ...
              />
              <button
                onClick={() => { if(newRoomInput.trim()){ addRoom(newRoomInput); setNewRoomInput(''); } }}
                className="bg-gray-600 hover:bg-gray-700 text-white text-xs font-bold px-3 py-1.5 rounded cursor-pointer shrink-0"
              >
                ＋ 追加
              </button>
            </div>
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 space-y-3">
            ...
            <div className="flex gap-1.5">
              ...
              />
              <button
                onClick={() => { if(newCategoryInput.trim()){ addCategory(newCategoryInput); setNewCategoryInput(''); } }}
                className="bg-gray-600 hover:bg-gray-700 text-white text-xs font-bold px-3 py-1.5 rounded cursor-pointer shrink-0"
              >
                ＋ 追加
              </button>
      ...
      {/* 💡 【新機能】設備グループ一括選択マスター管理エリア（UIトーンを合わせてここに追加） */}
      <div className="pt-5 border-t border-gray-150">
        <h2 className="text-sm font-bold text-gray-700 mb-3 flex items-center gap-1.5 border-b pb-1.5">
          👥 設備グループ一括選択マスター設定
        </h2>
          ...
          <div className="w-full lg:w-1/3 space-y-4">
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 space-y-3">
                  ...
                  deviceGroups.map((g) => (
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="text-red-600 hover:bg-red-50 px-1.5 py-0.5 rounded font-bold"
                      >
                        削除
                      </button>
                    </div>
              ...
              <div className="flex gap-1.5">
                ...
                />
                <button
                  onClick={() => { if(newGroupName.trim()){ addDeviceGroup(newGroupName.trim()); setNewGroupName(''); } }}
                  className="bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold px-3 py-1.5 rounded cursor-pointer shrink-0 shadow-sm"
                >
                  作成
                </button>
              </div>
